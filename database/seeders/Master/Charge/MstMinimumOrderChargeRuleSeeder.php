    ...
    public function run(): void
    {
        ...
        DB::table('mst_minimum_order_charge_rules')->insert([
            ...
            [
                ...
                'rule_no' => MstSeqCodeGenerator::getNextRuleNo(),
                'description' => 'Platform Fee for Listing Weight Below or equal to 100 kg for Seller',
                'calc_base' => 'weight',
                'calc_type' => 'fixed',
                'calc_condition' => '<=',
                'min_order_weight' => 100.00,
                'charge_amount' => 60.00,
                'is_active' => true,
                'created_at' => now(),
                'updated_at' => now(),
            ...
            [
                ...
                'charge_level_id' => $standardPriceLevelSeller->id,
                'rule_no' => MstSeqCodeGenerator::getNextRuleNo(),
                'description' => 'Platform Fee for Listing Weight Above 100 kg for Seller',
                'calc_base' => 'weight',
                'calc_type' => 'fixed',
                'calc_condition' => '>',
                'min_order_weight' => 100.00,
            ...
            [
                ...
                'rule_no' => MstSeqCodeGenerator::getNextRuleNo(),
                'description' => 'Platform Fee for Delivery Qty <= 5 for Delivery',
                'calc_base' => 'qty',
                'calc_type' => 'fixed',
                'calc_condition' => '<=',
                'min_order_qty' => 5.00,
