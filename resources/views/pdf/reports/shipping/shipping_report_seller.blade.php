...
<body>
    ...
    <div class="header">
        ...
        <div class="title">Shipping Report</div>
        ...
        <table>
            ...
            @foreach ($product_summary as $p)
                <tr>
                    ...
                    <td class="right">{{ $p['sold_qty'] }}</td>

                    <td class="right">{{ $p['shipped_qty'] }}</td>

                    <td class="right">
                        {{ $p['listed_weight'] }} {{ $p['pack_unit'] }}
                    </td>
    ...
    @foreach ($seller_reports as $seller)
        <div class="section">

            <div class="sellerbox">

                <b>Seller :</b> {{ $seller['seller']->name }}<br>

                <span class="meta">
                    Code : {{ $seller['seller']->user_code }} |
            ...
            <table>
                ...
                @foreach ($seller['items'] as $item)
                    <tr>
                        ...
                        <td class="right">{{ $item['sold_qty'] }}</td>

                        <td class="right">{{ $item['shipped_qty'] }}</td>
                ...
                @foreach ($seller['total'] as $t)
                    <tr class="total">
                        ...
                        <td class="right">{{ $t['sold_qty'] }}</td>

                        <td class="right">{{ $t['shipped_qty'] }}</td>
        ...
        <table>
            ...
            @foreach ($grand_totals as $g)
                <tr class="total">
                    ...
                    <td class="center">{{ $g['pack_unit'] }}</td>

                    <td class="right">{{ $g['qty'] }}</td>

                    <td class="right">{{ $g['sold_qty'] }}</td>

                    <td class="right">{{ $g['shipped_qty'] }}</td>
