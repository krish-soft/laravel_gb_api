...
class JobBuyerCutoffDemandOrder implements ShouldQueue
{
    use Queueable, Batchable;

    protected array $demandOrderIds;

    public function __construct(array $orderIds)
    {
        $this->demandOrderIds = $orderIds;
    }
    ...
    public function handle(): void
    {
        ...
        try {
            ...
            DB::transaction(function () {
                ...
                $orderIds = $this->demandOrderIds;

                $demandOrders = DemandOrder::with(['demandOrderItems'])
                    ->whereIn('id', $orderIds)
                    ->get();
