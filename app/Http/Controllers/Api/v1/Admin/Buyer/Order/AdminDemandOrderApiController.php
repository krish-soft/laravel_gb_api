...
class AdminDemandOrderApiController extends ApiResponseWithAdminAuthController
{
    //
    ...
    public function getOrdersList(Request $request)
    {
        ...
        $orderQuery = DemandOrder::with(['buyer', 'depot', 'shippingFulfillmentLocation.address'])->latest();
    ...
    public function getOrderDetails($orderId)
    {
        ...
        $order = DemandOrder::with([
            ...
            'shipmentPackages.shipment', // for shipment details
